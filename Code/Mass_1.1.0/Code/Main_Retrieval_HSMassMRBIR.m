function Main_Retrieval_HSMassMRBIR(filepath, Paras)
% MassMRBIR method
...
if ~strcmpi(methodname, 'HSMassMRBIR')
...
load(strcat(localpath, 'hsmassgraph_l1_', dataname, '_', num2str(NumTree), '_', num2str(NumSub), '_', num2str(NumDim), '.mat'));
