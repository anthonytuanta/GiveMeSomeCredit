function Main_Retrieval_InstRank(filepath, Paras)
% InstRank method
...
if ~strcmpi(methodname, 'InstRank')
...
load(strcat(localpath, 'dist_', dataname, '.mat'));
...
Time_Dist_Query = Time_avgDistance(1);
Time_Dist_RF = Time_avgDistance(F_num);
Time_add = zeros(1, fb_round + 1);
Time_add(1) = Time_Dist_Query;
Time_add(2:end) = Time_Dist_RF;
