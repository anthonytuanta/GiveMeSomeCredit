function Main_Retrieval_HSMassIR(filepath, Paras)
% MassInstRank method
...
% if ~strcmpi(methodname, 'HSMassIR')
    ...
    for query_index = 1:query_num
        ...
        for fbp_index = 1:fb_process
            ...
            for fbr_index = 2:fb_round + 1
                ...
                [Curt_Score, Time{fbp_index, fbr_index}] = CBIR_InstSim(Relevant_Index, Irrelevant_Index, Pre_Distance);
